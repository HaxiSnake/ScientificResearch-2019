...
for i in range(38):
    ...
    #pro=ProjectSingle.objects.get(project_code = row[1])
    # try:
    #     pro.trade_code = NationalTradeCode.objects.get(category = NATIONAL_TRADE_CODE_DICTS[row[3]])
    #     pro.save()
    # except:
    #     print i
    print i+1
...
print "_____________________finish___________________"
# print "hello"
