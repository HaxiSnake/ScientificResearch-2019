        ...
        def wrappered_method(request, *args, **kwargs):
            ...
            if identity == ADMINSTAFF_USER and check_auth(user=request.user, authority=ADMINSTAFF_USER):
                is_submited={SUBMIT_STATUS_APPLICATION:True,
                     ...
                     SUBMIT_STATUS_APPLICATION_FILE:True,
                     SUBMIT_STATUS_TASK_FILE:True,
                     SUBMIT_STATUS_PROGRESS_FILE:True,
                     SUBMIT_STATUS_FINAL_FILE:True,
                    }
                ...
                is_submited={SUBMIT_STATUS_APPLICATION:True,
                     ...
                     SUBMIT_STATUS_BUDGET:False,
                     SUBMIT_STATUS_AUDITE:False,
                     SUBMIT_STATUS_APPLICATION_FILE:False,
                     SUBMIT_STATUS_TASK_FILE:False,
                     SUBMIT_STATUS_PROGRESS_FILE:False,
                     SUBMIT_STATUS_FINAL_FILE:False
                    }
