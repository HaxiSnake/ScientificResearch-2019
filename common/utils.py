    ...
    if userauth['role']=="school":
        if userauth['status']=="application":
            ...
            pending=create_QE(PROJECT_STATUS_TASK_COMMIT_OVER)|\
                    create_QE(PROJECT_STATUS_PROGRESS_COMMIT_OVER)|\
                    create_QE(PROJECT_STATUS_FINAL_COMMIT_OVER)|\
                    create_QE(PROJECT_STATUS_FINAL_EXPERT_SUBJECT)|\
                    create_QE(PROJECT_STATUS_FINAL_COLLEGE_OVER)
