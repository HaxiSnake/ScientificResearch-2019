...
PROJECT_STATUS_PENDDING={
    ...
    (PROJECT_STATUS_FINAL_COMMIT_OVER,u"等待学院审核结题书"),
    (PROJECT_STATUS_FINAL_COLLEGE_OVER,u"等待专题管理员审核结题书"),
...
NEXT_PROGRESS_PERMISSION_DICT={
    ...
    COLLEGE_USER:(PROJECT_STATUS_APPLICATION_COLLEGE_OVER,PROJECT_STATUS_FINAL_COLLEGE_OVER,),
...
PROGRESS_REVIEW_DICT={
    ...
    PROJECT_STATUS_APPLICATION_WEB_OVER       :{NEXT_STATUS:PROJECT_STATUS_APPLICATION_COMMIT_OVER   ,ROLLBACK_STATUS:None                               ,PENDDING_STATUS:u"请上传申请书文件"          },
    ...
    PROJECT_STATUS_TASK_FINANCE_OVER          :{NEXT_STATUS:PROJECT_STATUS_TASK_COMMIT_OVER          ,ROLLBACK_STATUS:PROJECT_STATUS_APPROVAL            ,PENDDING_STATUS:u"请上传任务书文件"          },
    ...
    PROJECT_STATUS_PROGRESS_WEB_OVER          :{NEXT_STATUS:PROJECT_STATUS_PROGRESS_COMMIT_OVER      ,ROLLBACK_STATUS:None                               ,PENDDING_STATUS:u"请上传进展报告文件"        },
    ...
    PROJECT_STATUS_FINAL_WEB_OVER             :{NEXT_STATUS:PROJECT_STATUS_FINAL_COMMIT_OVER         ,ROLLBACK_STATUS:None                               ,PENDDING_STATUS:u"请上传结题书文件"          },
    PROJECT_STATUS_FINAL_COMMIT_OVER          :{NEXT_STATUS:PROJECT_STATUS_FINAL_COLLEGE_OVER        ,ROLLBACK_STATUS:PROJECT_STATUS_FINAL_FINANCE_OVER  ,PENDDING_STATUS:u"等待学院审核结题书"        },
    PROJECT_STATUS_FINAL_COLLEGE_OVER         :{NEXT_STATUS:PROJECT_STATUS_FINAL_SCHOOL_OVER         ,ROLLBACK_STATUS:PROJECT_STATUS_FINAL_FINANCE_OVER  ,PENDDING_STATUS:u"等待专题管理员审核结题书"  },
